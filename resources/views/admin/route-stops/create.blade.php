    ...
    <div class="container-fluid px-4">
        ...
        <div class="hero-shell mb-4">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div>
                    <h2 class="title">Tambah Route Stop</h2>
                    <p class="subtitle">Menambahkan urutan halte pada rute transportasi</p>
                </div>
                ...
                <form action="{{ route('admin.route-stops.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="stop_order" class="form-control" placeholder="Contoh: 1"
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="number" step="0.01" name="distance_from_start_km" class="form-control"
                                placeholder="Contoh: 12.50" value="{{ old('distance_from_start_km') }}">
                        </div>
                        ...
                        <div class="col-12">
                            <div class="alert alert-info mt-2">
                                ...
                                Estimasi waktu (ETA) dihitung otomatis oleh sistem berdasarkan jarak dan kecepatan
                                rata-rata.
                            </div>
                        </div>
